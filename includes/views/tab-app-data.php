		...
		<tr>
			<th scope="row">
				...
				<div class="wcs-tooltip">
					...
					<span class="wcs-tooltip-text"><?php esc_html_e( 'If enabled, all database tables, options, transients, and user meta created by the plugin will be deleted when you uninstall.', 'ozulabs-turbo-search-for-woocommerce' ); ?></span>
				</div>
			</th>
			<td>
				<fieldset>
