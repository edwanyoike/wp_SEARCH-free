 ...
 * reported against uninstall.php: calling otsw_delete_notice_dismissals()
 * (or otsw_uninstall_single_site()) in isolation, as UninstallTest does,
 ...
 * otsw_uninstall_single_site() itself correctly refused.
 *
...
final class UninstallFullDispatchTest extends TestCase {
	 ...
	 * otsw_test_active_plugins_by_site, which the is_plugin_active() fake
